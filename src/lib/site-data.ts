...
export const industries = [
  {
    ...
    lede: "Fintech, crypto and financial advisors. Claims legal will actually approve. Trust pages that rank and survive review.",
    body: "Regulated categories punish thin content and carnival PR. We build sourceworthy pages, clean technical access and authority that a compliance team can live with.",
  ...
  },
  {
    ...
    lede: "Agents, brokers and property companies. Area pages, listing intent and local pack without duplicate-city sludge.",
    body: "Property search is local, comparative and impatient. We map area + service intent, tighten GBP and stop the site cloning itself across suburbs.",
  ...
  },
  {
    ...
    lede: "HVAC, plumbing, landscaping, roofing. The phone has to ring from people in the service area this week.",
    body: "Home services win on local intent, proof and a page that makes booking obvious. We build service + area coverage, reviews and conversion paths.",
    fit: ["HVAC", "Plumbing", "Roofing & landscaping"],
  },
  {
    slug: "pet-services",
    group: "Services",
    ...
    lede: "Veterinarians and pet businesses. Local trust, service pages and the queries owners actually type at 11pm.",
    body: "Pet search is urgent and local. We cover services, conditions and locations without turning the clinic site into a content mill.",
    fit: ["Vets", "Grooming", "Boarding & retail"],
  },
  {
    slug: "gaming",
    ...
    mangaName: "Raid Form",
    lede: "Game developers and gaming businesses. Category language, patch-proof IA and pages that survive algorithm weather.",
    body: "Gaming SEO is competitive and noisy. We pick the commercial clusters, kill cannibal pages and build the library players and partners actually use.",
    fit: ["Studios", "Platforms", "Esports & tools"],
  },
  {
    slug: "football",
    group: "Entertainment & Sports",
    ...
    mangaName: "Pitch Arc",
    lede: "Clubs, academies and soccer businesses. Coverage around the searches fans and parents already make.",
    body: "Football sites drown in news and starve the commercial pages. We rebuild around trials, memberships, apps and local academy demand.",
    fit: ["Clubs", "Academies", "Football apps"],
  },
];
...
export const whoWeHelp = [
  ...
  },
  {
    ...
    text: "UK, US and AU teams that want senior SEO with a Philippines-based delivery dojo.",
  },
  {
    name: "Agency partners",
    text: "White-label delivery. Your brand, our work, approval-gated, no poaching.",
  },
  {
    name: "Service & ecommerce teams",
    text: "Sites with traffic that is not turning into enough enquiries, calls or sales.",
  },
];
