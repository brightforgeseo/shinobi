...
export const industryPages: IndustryPage[] = [
  {
    ...
    red: "BEFORE SCALE.",
    intro:
      "SEO for high-trust finance and crypto businesses where credibility matters as much as traffic. Searchers compare risk, regulation, platform credibility, costs, security and evidence before they act. Thin content or hype-led pages can do more harm than good.",
  ...
  },
  {
    ...
    red: "LISTINGS, TRUST.",
    intro:
      "SEO for property businesses where location, trust, listings and lead quality have to work together. Buyers and sellers compare locations, property types, agents, developments and advice before they ever make contact.",
  ...
  },
  {
    ...
    red: "SERVICE AREA.",
    intro:
      "SEO for trade and home service businesses where calls, trust and service-area coverage matter. Not just ranking a homepage — strong service pages, local signals, Google Business Profile, review proof and a site that makes it easy to enquire.",
  ...
  },
  {
    ...
    red: "LOCAL DEMAND.",
    intro:
      "SEO for pet businesses where local trust, service clarity and helpful content drive real enquiries. Owners search with practical intent: vets near me, grooming prices, trainers, stores, symptoms, services and care questions.",
  ...
  },
  {
    ...
    red: "NOT HYPE.",
    intro:
      "SEO for gaming brands that need players, signups and communities — not vanity traffic. Discovery, guides, app comparisons, community searches, reviews, updates and brand queries. Useful demand, without relying on hype.",
  ...
  },
  {
    ...
    intro:
      "SEO for football brands where fixtures, fans, players, clubs and timing shape search demand. Academies, player questions, club information, apps and fan content all create demand at different points in the season. SEO has to account for that movement.",
